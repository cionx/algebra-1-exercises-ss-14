...
\]
surjektiv ist. Da $R^n$ noethersch ist, ergibt sich aus dem vorherigen Aufgabenteil durch die kurze exakte Sequenz
\[
 0 \to \ker f \hookrightarrow R^n \xlongrightarrow{f} M \to 0,
\]
dass auch $M$ noethersch ist.
